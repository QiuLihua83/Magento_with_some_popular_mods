 ...
 *
 * @author     Qun WU <info@jerrywebsolutions.com>
 */
class Jerry_Storelocator_Block_Adminhtml_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     * Edit Block model
     *
    ...
    protected function _toHtml()
    {
        $javascript = <<<EOT
            ...
            <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=sHO7yWrZ6CoBB0EzfVGrkKfg"></script>
